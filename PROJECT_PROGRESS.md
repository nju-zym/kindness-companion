# Kindness Companion (善行伴侣) v3.0 项目进展与计划
...
*   **🎯 AI 个性化推荐 (`ai_core/` & `frontend/`):**
    *   `recommendation_engine.py`: **TODO:** 实现调用推荐系统 API 或文本分析/向量数据库 API 的逻辑，基于用户历史打卡记录和偏好推荐新的善行伴侣。(#README.md:58)
...
6.  **探索未来增强功能:**
    *   **TODO:** 实现 AI 个性化推荐功能，根据用户历史数据推荐合适的善行伴侣。
