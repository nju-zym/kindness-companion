...
try:
    ...
    logging.error("Failed to import ZHIPUAI_API_KEY from config.py. Make sure the file exists and the variable is set.")
    ZHIPUAI_API_KEY = None

logger = logging.getLogger(__name__)


def get_zhipuai_completion(messages, model="glm-4-flash-250414"):
    """
