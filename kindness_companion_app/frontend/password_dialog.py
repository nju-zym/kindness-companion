...
class PasswordDialog(BaseDialog):
    ...
    def setup_ui(self):
        ...
        current_pwd_label.setAlignment(
            Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter
        )
        new_pwd_label = QLabel("新密码:")
        new_pwd_label.setAlignment(
            Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter
        )
        confirm_pwd_label = QLabel("确认新密码:")
        confirm_pwd_label.setAlignment(
            Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter
        )
    ...
    def save_password(self):
        ...
        # 验证当前密码
        user = self.user_manager.login(self.current_user["username"], current_password)
