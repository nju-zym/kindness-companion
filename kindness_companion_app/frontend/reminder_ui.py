...
class ReminderWidget(QWidget):
    ...
    def apply_theme_settings(self):
        ...
        theme_type_text = (
            "跟随系统"
            if self.theme_manager.follow_system
            else ("浅色" if self.theme_manager.current_theme == "light" else "深色")
        )
        theme_style_text = (
            "温馨"
            if self.theme_manager.theme_style == "warm"
            else ("Sourcio" if self.theme_manager.theme_style == "sourcio" else "标准")
        )
        ...
        self.theme_changed.emit(
            self.theme_manager.current_theme, self.theme_manager.theme_style
        )
