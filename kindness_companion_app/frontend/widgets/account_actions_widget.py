...
class AccountActionsWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.change_password_button.setObjectName("change_password_button") # Add object name
        # 使用文本代替图标，避免SVG加载问题
        ...
        self.delete_account_button.setObjectName("delete_account_button") # Keep object name
        # 使用文本代替图标，避免SVG加载问题
