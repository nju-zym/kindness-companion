...
class TestConversationAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Mock the cursor attribute and its execute method
        self.db_manager.cursor = MagicMock()
        self.db_manager.cursor.execute = MagicMock()

        # Mock the connection attribute and its commit method
        ...
        with patch(
            "kindness_companion_app.ai_core.conversation_analyzer.ConversationAnalyzer._ensure_tables_exist"
        ):
        ...
        self.sample_profile = {
            ...
            "emotional_state": {"current_mood": "positive", "stress_level": "low"},
            "thinking_patterns": {
                "analytical": "medium",
                "creative": "high",
                "practical": "medium",
    ...
    def test_get_conversation_history(self):
        ...
        args, _ = self.db_manager.execute_query.call_args
    ...
    def test_analyze_user_psychology(self, mock_make_api_request):
        ...
        self.analyzer.get_conversation_history = MagicMock(
            return_value=[
        ...
        mock_make_api_request.return_value = {
            "choices": [{"message": {"content": json.dumps(self.sample_profile)}}]
        }
        ...
        self.analyzer.get_conversation_history.assert_called_once_with(1, limit=50)
    ...
    def test_generate_dialogue_with_style(self, mock_make_api_request):
        ...
        self.analyzer.get_dialogue_style = MagicMock(
            return_value={
                "formality_level": 4,
                "verbosity_level": 3,
                "empathy_level": 5,
        ...
        # Mock the API response
        mock_make_api_request.return_value = {
            "choices": [{"message": {"content": "It's nice to meet you!"}}]
        }

        # Call the method
        dialogue, context_id = self.analyzer.generate_dialogue_with_style(
            user_id=1, prompt="Tell me about yourself", context_id="ctx_1"
        )
        ...
        # Check that get_conversation_history was called
        self.analyzer.get_conversation_history.assert_called_once_with(
            1, limit=10, context_id="ctx_1"
        )
