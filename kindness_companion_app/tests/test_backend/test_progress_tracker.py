...
class TestProgressTracker(unittest.TestCase):
    ...
    def test_get_completion_rate(self):
        ...
        # Configure the mock to return counts
        self.mock_db_manager.execute_query.side_effect = [
            [{"count": 3}],  # Total check-ins
            [{"min_date": "2023-01-01"}]  # First check-in date
        ]
        ...
        # Check that the result is the expected rate (3 check-ins out of 10 days = 30%)
