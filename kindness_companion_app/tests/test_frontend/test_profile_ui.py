...
class TestProfileUI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create a ProfileWidget instance with the mock user manager
        self.profile_widget = ProfileWidget(self.mock_user_manager)
    ...
    def test_toggle_ai_consent_update_failed(self):
        ...
        # Toggle AI consent
        with patch('frontend.widgets.animated_message_box.AnimatedMessageBox.showWarning') as mock_show_warning:
            self.profile_widget.toggle_ai_consent(Qt.Checked)
